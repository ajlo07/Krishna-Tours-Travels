...
<head>
    ...
    <title>Krishna Tours & Travels</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ourCars.php">Our Cars</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <!-- <div class="ms-4">
                        <a href="#section_3" class="btn custom-btn
                                custom-border-btn smoothscroll">Get started</a>
                    </div> -->
                </div>
            </div>
        </nav>